<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JudgeCompetition.aspx.cs" Inherits="ASPNET_APP.Pages.JudgeCompetition" %>
    ...
    <form id="form2" runat="server">
        <div style="text-align: center">
            ...
            <b>Просмотр категорий соревнования</b><br />
                <br />
        <asp:Label ID="Label1" runat="server" Text="Список категорий:"></asp:Label>
        <br />
